              ...
              >
                <template #default="scope">
                  <el-row :gutter="10" class="mb8">
                    ...
                    <el-col :span="1.5">
                      <el-button link type="primary" size="small" icon="CopyDocument" @click="handleCopyDef(scope.row)"
                        >复制流程</el-button
                      >
                    </el-col>
                  </el-row>
                  <el-row :gutter="10" class="mb8">
                    <el-col :span="1.5">
                      <el-button
                        ...
                        >流程设计</el-button
                      >
                      <el-button link type="primary" v-else icon="View" size="small" @click="designView(scope.row)"
                        >查看流程</el-button
                      >
                    </el-col>
                    <el-col v-if="scope.row.isPublish !== 1" :span="1.5">
                      <el-button link type="primary" size="small" icon="CircleCheck" @click="handlePublish(scope.row)"
                        >发布流程</el-button
                      >
                    </el-col>
                  </el-row>
...
import type { FlowDefinitionQuery, FlowDefinitionVo, FlowDefinitionForm } from '@/api/workflow/definition/types';
import { type UploadRequestOptions, type TabsPaneContext } from 'element-plus';
