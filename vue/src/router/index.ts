...
export const constantRoutes: RouteRecordRaw[] = [
  {
    ...
    children: [
      {
        path: '/redirect/:path(.*)',
        component: async () => import('@/views/redirect/index.vue'),
      },
    ],
  },
  {
    ...
    hidden: true,
    component: async () => import('@/layout/components/SocialCallback/index.vue'),
  },
  {
    path: '/login',
  ...
  },
  {
    ...
    children: [
      {
        path: 'profile',
        component: async () => import('@/views/system/user/profile/index.vue'),
        name: 'Profile',
